...
#
# Script generated by Vivado on Thu Dec 19 12:06:42 +0100 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : PLL100to108.sh
...
#
# Usage        : PLL100to108.sh
#                PLL100to108.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                PLL100to108.sh [-reset_run]
#                PLL100to108.sh [-reset_log]
#                PLL100to108.sh [-help]
#
...
# script info
echo -e "PLL100to108.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./PLL100to108.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot PLL100to108 xil_defaultlib.PLL100to108 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim PLL100to108 -key {Behavioral:sim_1:Functional:PLL100to108} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/XILINX1/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb PLL100to108.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./PLL100to108.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: PLL100to108.sh [-help]\n\
Usage: PLL100to108.sh [-step]\n\
Usage: PLL100to108.sh [-lib_map_path]\n\
Usage: PLL100to108.sh [-reset_run]\n\
Usage: PLL100to108.sh [-reset_log]\n\
Usage: PLL100to108.sh [-keep_index]\n\
Usage: PLL100to108.sh [-noclean_files]\n\n\
