...
#                script (type 'PLL100to108.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.PLL100to108 xil_defaultlib.glbl -o PLL100to108_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./PLL100to108_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key PLL100to108_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc PLL100to108_simv.daidir vcs_lib c.obj)
