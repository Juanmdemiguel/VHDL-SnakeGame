...
#
# Script generated by Vivado on Thu Nov 28 12:08:57 +0100 2024
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xpm -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot top xil_defaultlib.top xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/juans/OneDrive/Documentos/Xilinx/Vivado/2024.1/data/xsim"
  fi
